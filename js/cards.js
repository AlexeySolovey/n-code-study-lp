...
[
  ...
  {
    name: "Анатолій",
    desc: " Представляємо вам Анатолія, нашого викладача. Він має досить довгий та насичений досвід роботи . Анатолій вже має навики викладання і ведення студентів, тому впевнено зможе передати свої знання вам.. У своїй основній роботі  працює з UI/UX,Grafic and Web-Design, 2д моушен для початківців.",
    imgUrl: "img/tutors/anatolii.jpg",
    cource: "Web Design"
  },
  {
    name: "Андрій",
  ...
  {
    name: "Олексій",
    desc: "Олексій – наш талановитий викладач. Досвід роботи у сфері веб-розробки- 3+ роки. Олексій експерт в HTML5, CSS3, SCSS, JavaScript (JS), TypeScript (TS), React, Redux, Next.js, MUI.  Його знання та досвід допоможуть Вам  опанувати  найсучасніші технології веб-розробки.",
    imgUrl: "img/tutors/oleksii.jpg",
    cource: "Front-End"
  },
  {
    name: "Сергій",
    desc: "Дозвольте вас познайомити з Сергієм – нашим професіоналом, у якого 2 роки комерційного досвіду. Він вже здобув великий практичний багаж з веб-розробки. Сергій готовий поділитися своїми знаннями та надати підтримку у навчанні.",
